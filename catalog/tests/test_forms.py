...
class RenewBookInstancesViewTest(TestCase):
        ...
        def setUp(self):
            ...
            my_admin = User.objects.create_superuser('myuser', 'myemail@test.com', '123123zxc')
            my_admin.save()
            #Создание книги
        ...
        def test_redirects_to_all_borrowed_book_list_on_success(self):
            ...
            self.assertRedirects(resp, reverse('book-borrowed') )
        ...
        def test_redirect_if_logged_in_but_not_correct_permission_author(self):
            login = self.client.login(username='testuser1', password='12345')
